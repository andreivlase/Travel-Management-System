...
public:
    ...
    void cabDetails()
    {
        ...
        cout << "-----------ABC Cabs-----------\n" << endl;
        cout << "1. Rent a Standard Cab - Eu.15 for 1KM" << endl;
        cout << "2. Rent a Luxury Cab - Eu.25 per 1KM" << endl;
        ...
        if(cabChoice == 1){
            ...
            cout << "\nYour tour will cost " << cabCost << " euros for a standard cab" << endl;
            ...
            cout << "\nYour tour will cost " << cabCost << " euros for a luxury cab" << endl;
            cout << "Press 1 to hire this cab: or ";
            cout << "Press 2 to select another cab: ";
            cin >> hireCab;
            system("CLS");
...
public:
    ...
    void hotels()
    {
        ...
        if(choiceHotel == 1){
            ...
            cout << "\tAll basic facilities you need just for: Eu.5000.00" << endl;
            cout << "2. Premium Pack" << endl;
            cout << "\tEnjoy Premium: Eu.10000.00" << endl;
            cout << "3. Luxury Pack" << endl;
            cout << "\tLive a Luxury at Avendra: Eu.15000.00" << endl;
            ...
            cout << "\t Eu.15000.00 for a day" << endl;
            cout << "2. Couple Pack" << endl;
            cout << "\t Eu.10000.00 for a day" << endl;
            ...
            cout << "Amazing offer in this summer: Eu.5000.00 for a one day!!!" << endl;
